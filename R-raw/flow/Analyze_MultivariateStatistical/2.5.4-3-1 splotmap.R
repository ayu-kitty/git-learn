...
if(this.path::is.main() & !is.null(whereami::thisfile_r())){
  ...
  map_mulstatistics_splotmap <- map_autodraw$new(splotmap_obj)$draw
  ...
  result <- do.call(what = map_mulstatistics_splotmap,args = args) 
